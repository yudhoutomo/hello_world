...
import '../ui/cubit/cubit/flight_cubit.dart' as _i10;
import 'app_modules.dart' as _i12;
import 'network_modules.dart' as _i11;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i10.FlightCubit>(() => _i10.FlightCubit(get<_i9.UserApi>()));
  return get;
}
